...
const inputSt: React.CSSProperties = {
  ...
  padding: '12px 14px',
  borderRadius: '4px',
  border: '1.5px solid rgba(26,43,71,0.15)',
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16">
          ...
          <Reveal className="lg:col-span-3">
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input id="name" type="text" required autoComplete="name" value={form.name} onChange={set('name')} placeholder="Jan Kowalski" style={inputSt}
                    onFocus={(e) => focus(e.currentTarget)} onBlur={(e) => blur(e.currentTarget)} />
                </div>
                <div>
              ...
              <motion.button
                ...
                style={{
                  fontFamily: 'var(--font-dm)',
                  backgroundColor: status === 'sent' ? '#2D7A4F' : '#1A2B47',
                  color: '#F5F3EF',
                  borderRadius: '4px',
                  border: 'none',
                  fontSize: '15px',
          ...
          <Reveal delay={0.2} className="lg:col-span-2 flex flex-col gap-5">
            <div className="p-6 flex flex-col gap-4" style={{ backgroundColor: '#FAFAF8', border: '1px solid rgba(26,43,71,0.10)', borderRadius: '8px', boxShadow: '0 2px 12px rgba(26,43,71,0.08)' }}>
              {[
            ...
            <div className="p-6 flex-1" style={{ backgroundColor: '#FAFAF8', border: '1px solid rgba(26,43,71,0.10)', borderRadius: '8px', boxShadow: '0 2px 12px rgba(26,43,71,0.08)' }}>
